...
Проверка на подключенном Android после установки 27.05:

- Установлена свежая debug-сборка `versionName=1.0.23`, `versionCode=24`,
  `lastUpdateTime=2026-05-27 16:04:23`.
- Ручная синхронизация через вкладку `Часы` прошла через один `service-sync`.
- Геолокация и погода пришли с телефона: `София, Болгария`, `temp=27`,
  `humidity=36`, `wind=2/27`, `uv=5`, `aqi=36`, `pressure=1015.4`,
  `sunrise=2026-05-27T05:53:00+03:00`,
  `sunset=2026-05-27T20:53:00+03:00`.
...
- Прочитанные файлы после фильтра:
  ...
  - `1CEA166A0C0300` - minute activity v3, `complete`, `crc=true`,
    `parsed=true`;
  - `E0E9166A0C0300` - minute activity v3, `complete`, `crc=true`,
    `parsed=true`.
