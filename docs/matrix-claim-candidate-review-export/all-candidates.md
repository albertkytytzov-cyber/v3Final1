...
- candidateCount=15
- exportItemCount=80
- manualVerificationStillRequiredCount=2
- sourceTextStillRequiredCount=12
- finalEvidenceClaimCount=0
- runtimeChangeAllowedNow=false
- humanReviewed=false
- candidateOnly=true
- coachReviewCount=15
- medicalReviewCount=15
- dataQualityReviewCount=11
- sportScienceReviewCount=13
- productSafetyReviewCount=11
- manualSourceVerificationCount=0
- sourceTextAcquisitionCount=15
...
## claim_candidate_review_export_coach_candidate_weight_cut_hydration_safety_context
...
Next action:
Route this candidate to coach review outside code and keep it candidate-only until real review results exist.
...
## claim_candidate_review_export_data_quality_candidate_weight_cut_hydration_safety_context
...
- linked data dependency ids: body_mass_trend_for_weight_cut, hydration_status_for_weigh_in
- reviewer notes recorded outside code
- data_quality reviewer rationale
- explicit keep-blocked or future-review recommendation
...
Next action:
Route this candidate to data_quality review outside code and keep it candidate-only until real review results exist.
...
## claim_candidate_review_export_medical_candidate_weight_cut_hydration_safety_context
...
Next action:
Route this candidate to medical review outside code and keep it candidate-only until real review results exist.
...
## claim_candidate_review_export_product_safety_candidate_weight_cut_hydration_safety_context
...
- linked data dependency ids: body_mass_trend_for_weight_cut, hydration_status_for_weigh_in
- reviewer notes recorded outside code
- product_safety reviewer rationale
- explicit keep-blocked or future-review recommendation
...
Next action:
Route this candidate to product_safety review outside code and keep it candidate-only until real review results exist.
...
## claim_candidate_review_export_source_text_acquisition_candidate_weight_cut_hydration_safety_context
...
Next action:
Acquire and review source text outside code before any later extraction-readiness stage.
...
## claim_candidate_review_export_coach_candidate_hydration_heat_exposure_review_context
...
## claim_candidate_review_export_data_quality_candidate_hydration_heat_exposure_review_context
...
## claim_candidate_review_export_medical_candidate_hydration_heat_exposure_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_hydration_heat_exposure_review_context
...
## claim_candidate_review_export_coach_candidate_readiness_multi_signal_context
...
## claim_candidate_review_export_data_quality_candidate_readiness_multi_signal_context
...
## claim_candidate_review_export_medical_candidate_readiness_multi_signal_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_readiness_multi_signal_context
...
## claim_candidate_review_export_coach_candidate_wearable_data_quality_context
...
## claim_candidate_review_export_data_quality_candidate_wearable_data_quality_context
...
## claim_candidate_review_export_medical_candidate_wearable_data_quality_context
...
## claim_candidate_review_export_product_safety_candidate_wearable_data_quality_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_wearable_data_quality_context
...
## claim_candidate_review_export_coach_candidate_sleep_readiness_review_context
...
## claim_candidate_review_export_data_quality_candidate_sleep_readiness_review_context
...
## claim_candidate_review_export_medical_candidate_sleep_readiness_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_sleep_readiness_review_context
...
## claim_candidate_review_export_coach_candidate_rhr_hrv_trend_review_context
...
## claim_candidate_review_export_data_quality_candidate_rhr_hrv_trend_review_context
...
## claim_candidate_review_export_medical_candidate_rhr_hrv_trend_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_rhr_hrv_trend_review_context
...
## claim_candidate_review_export_coach_candidate_female_energy_availability_context
...
## claim_candidate_review_export_data_quality_candidate_female_energy_availability_context
...
## claim_candidate_review_export_medical_candidate_female_energy_availability_context
...
## claim_candidate_review_export_product_safety_candidate_female_energy_availability_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_female_energy_availability_context
...
## claim_candidate_review_export_coach_candidate_pain_review_context

Audience: coach
Candidate: candidate_pain_review_context
Title: Pain review context candidate
Candidate status: needs_full_text_before_extraction
Candidate type: injury_pain_context
candidateOnly=true
runtimeChangeAllowedNow=false
humanReviewed=false
...
Reviewer questions:
- Should candidate_pain_review_context remain candidate-only, be rejected, or wait for another review packet?
- What source text, context, or reviewer artifact is still missing before later extraction work?
- Could this wording be misunderstood as a diagnosis, hard gate, or runtime instruction?
- Does this candidate match real wrestling coaching context without becoming an automatic rule?
- Which coach-facing caveats must stay visible if this remains in review export only?
...
Required artifacts:
- candidate id: candidate_pain_review_context
- linked source lookup ids: return_to_sport_pain_review_intake
- linked desk source review ids: desk_source_review_return_to_sport_pain_review_intake
- linked evidence dependency ids: nsca_youth_safe_progression, perform_evidence_matrix, recovery_monitoring_consensus
- linked data dependency ids: pain_location_severity_for_block_eligibility
- reviewer notes recorded outside code
- coach reviewer rationale
- explicit keep-blocked or future-review recommendation
...
Linked ids:
- desk source reviews: desk_source_review_return_to_sport_pain_review_intake
...
- review intakes: review_intake_source_lookup_return_to_sport_pain_review_intake

## claim_candidate_review_export_medical_candidate_pain_review_context
...
## claim_candidate_review_export_product_safety_candidate_pain_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_pain_review_context
...
## claim_candidate_review_export_coach_candidate_injury_return_review_context

Audience: coach
Candidate: candidate_injury_return_review_context
...
Reviewer questions:
- Should candidate_injury_return_review_context remain candidate-only, be rejected, or wait for another review packet?
- What source text, context, or reviewer artifact is still missing before later extraction work?
- Could this wording be misunderstood as a diagnosis, hard gate, or runtime instruction?
- Does this candidate match real wrestling coaching context without becoming an automatic rule?
- Which coach-facing caveats must stay visible if this remains in review export only?
...
Required artifacts:
- candidate id: candidate_injury_return_review_context
- linked source lookup ids: return_to_sport_injury_review_intake
- linked desk source review ids: desk_source_review_return_to_sport_injury_review_intake
- linked evidence dependency ids: nsca_youth_safe_progression, perform_evidence_matrix, recovery_monitoring_consensus
- linked data dependency ids: injury_status_for_return_to_training
- reviewer notes recorded outside code
- coach reviewer rationale
- explicit keep-blocked or future-review recommendation
...
Linked ids:
- desk source reviews: desk_source_review_return_to_sport_injury_review_intake
...
- review intakes: review_intake_source_lookup_return_to_sport_injury_review_intake

## claim_candidate_review_export_medical_candidate_injury_return_review_context
...
## claim_candidate_review_export_product_safety_candidate_injury_return_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_injury_return_review_context
...
## claim_candidate_review_export_coach_candidate_youth_progression_review_context
...
## claim_candidate_review_export_medical_candidate_youth_progression_review_context
...
## claim_candidate_review_export_product_safety_candidate_youth_progression_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_youth_progression_review_context
...
## claim_candidate_review_export_coach_candidate_bfr_kaatsu_safety_review_context
...
## claim_candidate_review_export_medical_candidate_bfr_kaatsu_safety_review_context
...
## claim_candidate_review_export_product_safety_candidate_bfr_kaatsu_safety_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_bfr_kaatsu_safety_review_context
...
## claim_candidate_review_export_coach_candidate_lmv_local_fatigue_review_context
...
## claim_candidate_review_export_data_quality_candidate_lmv_local_fatigue_review_context
...
## claim_candidate_review_export_medical_candidate_lmv_local_fatigue_review_context
...
## claim_candidate_review_export_product_safety_candidate_lmv_local_fatigue_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_lmv_local_fatigue_review_context
...
## claim_candidate_review_export_coach_candidate_taper_hidden_load_review_context
...
## claim_candidate_review_export_data_quality_candidate_taper_hidden_load_review_context
...
## claim_candidate_review_export_medical_candidate_taper_hidden_load_review_context
...
## claim_candidate_review_export_product_safety_candidate_taper_hidden_load_review_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_taper_hidden_load_review_context
...
## claim_candidate_review_export_coach_candidate_travel_fatigue_review_blocker_context
...
## claim_candidate_review_export_data_quality_candidate_travel_fatigue_review_blocker_context
...
## claim_candidate_review_export_medical_candidate_travel_fatigue_review_blocker_context
...
## claim_candidate_review_export_product_safety_candidate_travel_fatigue_review_blocker_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_travel_fatigue_review_blocker_context
...
## claim_candidate_review_export_coach_candidate_contact_load_review_blocker_context
...
## claim_candidate_review_export_data_quality_candidate_contact_load_review_blocker_context
...
## claim_candidate_review_export_medical_candidate_contact_load_review_blocker_context
...
## claim_candidate_review_export_product_safety_candidate_contact_load_review_blocker_context
...
## claim_candidate_review_export_source_text_acquisition_candidate_contact_load_review_blocker_context
