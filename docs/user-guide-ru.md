...
ИИ-разбор в Review не меняет план, дневник и отметки спортсмена. Он сохраняет только историю выводов и помогает тренеру быстрее понять, что произошло в выбранный день.

Новая структура разбора:
...
- **История ИИ-разборов** - свернутый список прошлых разборов по этому дню.
