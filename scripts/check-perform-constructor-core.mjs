...
const metadataCheckFiles = [
  ...
  "scripts/check-constructor-matrix-family-source-review.mjs",
  "scripts/check-constructor-matrix-p0-family-evidence-dossiers.mjs",
  "scripts/check-constructor-matrix-p1-family-evidence-dossiers.mjs",
  ...
  "docs/matrix-family-level-evidence-review-plan.md",
  "docs/matrix-family-source-review.md",
  "docs/matrix-p0-family-evidence-dossiers.md",
...
for (const token of [
  ...
  "check:constructor-matrix-family-source-review",
  "check:constructor-matrix-p0-family-evidence-dossiers",
  "check:constructor-matrix-p1-family-evidence-dossiers",
...
for (const [path, source] of [
  ...
  assert(
    source.includes("Matrix Save/Assign Controlled Pilot"),
    `${path} must document Matrix Save/Assign Controlled Pilot`,
  );
  assert(
